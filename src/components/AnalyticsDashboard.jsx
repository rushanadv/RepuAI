...
export default function AnalyticsDashboard() {
  ...
  return (
    <section id="analytics" className="relative py-28 px-4 sm:px-6 bg-[#08080c] border-t border-white/[0.05] overflow-hidden fade-in-section">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-[-0.03em] leading-[1.05]">
            Telemetry & root-cause intelligence across every location.
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="hairline-card p-7 rounded-2xl flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full bg-emerald-500 rounded-full transition-all duration-500" style={{ width: '58%' }} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full bg-amber-400 rounded-full transition-all duration-500" style={{ width: '22%' }} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full bg-rose-500 rounded-full transition-all duration-500" style={{ width: '20%' }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2.5 mt-4">
                {urgentReviews.map((rev, idx) => (
                  <div 
                    key={idx} 
                    className="p-3 rounded-xl bg-black/40 border border-white/[0.05] hover:border-white/15 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                  >
                    ...
                    <a
                      ...
                      className="text-xs font-semibold text-indigo-400 hover:text-indigo-300 flex items-center gap-1 self-end sm:self-center flex-shrink-0 transition-colors"
                    >
          ...
          {/* CARD 4: 7-Day Performance KPI Grid */}
          <div className="hairline-card p-7 rounded-2xl flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-5">
                <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
                  ...
                  <div className="flex items-baseline justify-between">
                    <span className="text-2xl font-extrabold text-indigo-300 font-mono">189</span>
                    <span className="text-xs font-semibold text-emerald-400 flex items-center font-mono">
